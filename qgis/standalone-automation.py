...
def set_map_bounding_box(country_code):
    ...
    QgsExpressionContextUtils.setProjectVariable(ProjectInstance, 'scalebar_unit_length',
                                                 scalebar_unit_length * scalebar_base / 100)
...
ProjectInstance.read(str(QGIS_FOLDER / "project_map_graph.qgz"))
